...
export default function Dashboard({
  ...
  const topAlert: SecurityAlert | undefined = alerts[0];
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <Card className="relative lg:col-span-5">
          ...
          <div className="relative flex h-full flex-col justify-between p-6">
            ...
            <p className="text-center text-[12px] leading-relaxed text-text-secondary">
              ...
              because we noticed unusual voice activity —{" "}
              <span className="font-semibold text-text-primary">{stats.openAlerts}</span> open
              alerts in the last 2 hours. Worth reviewing soon.
            </p>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:col-span-3 lg:grid-cols-1">
          <KpiTile
            ...
            plain={`${stats.openAlerts} open — ${urgentCount} need urgent action`}
          ...
          <Card glow="rgba(53,214,193,0.14)" className="flex flex-col justify-between p-5">
            <div className="flex items-start justify-between">
              ...
              <p className="text-[12px] text-text-secondary">{stats.threatsDetected} flagged</p>
            </div>
            <div>
              ...
              <p className="mt-0.5 text-[11px] text-text-disabled">
                {stats.threatsDetected} calls flagged for review
              </p>
            </div>
          </Card>
          <KpiTile
            ...
            plain={`Prevented $${Math.round(stats.lossesPreventedUsd / 1000)}K in fraud this month`}
            glow="rgba(124,108,255,0.16)"
          >
            <div className="space-y-0.5 text-right">
              <p>{stats.callsToday} calls</p>
              <p>{stats.falsePositiveRate}% false positives</p>
            </div>
          </KpiTile>
        </div>
        ...
        <Card className="relative overflow-hidden lg:col-span-4">
          ...
          <div className="relative flex h-full flex-col justify-between p-6">
            ...
            {topAlert ? (
              ...
              <p className="text-[12px] text-text-secondary">No active alerts right now.</p>
            )}
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <Card className="p-6 lg:col-span-5">
          ...
          <div className="mt-6 flex flex-col items-center gap-5 sm:flex-row">
            <Sonar value={trend[trend.length - 1]?.score ?? 72} />
            <div className="flex-1">
